...
if [ "${1-}" = "extract" ]; then
    extract_results "matmult_one" "matmult-onebank-results"
    extract_results "sdvbs_one" "sdvbs-onebank-results"
elif [ "${1-}" = "matmult" ]; then
    ...
    extract_results "matmult_one" "$RESULTS_DIR"
    ...
    extract_results "sdvbs_one" "$RESULTS_DIR"
